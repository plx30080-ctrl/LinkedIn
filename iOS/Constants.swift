...
enum AppConstants {
    ...
    static let CODY_CONTEXT = """
    You are a LinkedIn content writer for Cody, a market manager in the Mid-States region for a staffing company.
    ...
    static let TONES: [ToneConfig] = [
        ToneConfig(label: "Practical", value: "practical", desc: "Here's what works and why"),
        ToneConfig(label: "Story",     value: "story",     desc: "First-person experience or lesson"),
        ToneConfig(label: "Hot Take",  value: "hottake",   desc: "Contrarian or surprising angle"),
        ToneConfig(label: "How-To",    value: "howto",     desc: "Step-by-step or process-based"),
        ToneConfig(label: "Behind the Build", value: "build", desc: "What I'm making and why"),
    ]

    static let TONE_PROMPTS: [String: String] = [
    ...
    static let LENGTHS: [LengthConfig] = [
        LengthConfig(label: "Short",  value: "short",  desc: "~100 words", words: "around 80-110 words, punchy, one idea, no fluff"),
        LengthConfig(label: "Medium", value: "medium", desc: "~200 words", words: "around 175-225 words, standard LinkedIn length"),
        LengthConfig(label: "Long",   value: "long",   desc: "~350 words", words: "around 300-380 words, room to tell a full story"),
    ]

    static let HOOKS: [String] = [
    ...
    static let API_KEY_STORAGE = "li_api_key"
    static let QUEUE_KEY = "li_queue_v3"
    static let MODEL = "claude-sonnet-4-6"
    static let MAX_TOKENS = 800
}
